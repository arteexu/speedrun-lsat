...
> PRD (`docs/models/performance-model.md`). It is kept in sync with the in-repo
> copy at [`../speedrun/docs/models/performance-model.md`](../speedrun/docs/models/performance-model.md).
